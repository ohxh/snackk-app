...
import 'package:snackk/widgets/customer/restaurants/restaurant_list_tile.dart';
...
class RestaurantSearchOverlay extends StatefulWidget {
  ...
  @override
  _RestaurantSearchOverlayState createState() =>
      new _RestaurantSearchOverlayState();
}
...
class _RestaurantSearchOverlayState extends State<RestaurantSearchOverlay> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
          child: StreamBuilder(
        stream: CustomerDatabase.instance.restaurantsRef.snapshots().map(
            (doc) => doc.documents
                .map((res) => Restaurant.fromDocument(res))
                .toList()),
