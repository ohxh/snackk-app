...
class BreveCreditCard extends StatefulWidget {
  const BreveCreditCard({
    Key key,
  ...
  @override
  _BreveCreditCardState createState() => _BreveCreditCardState();
}

class _BreveCreditCardState extends State<BreveCreditCard>
