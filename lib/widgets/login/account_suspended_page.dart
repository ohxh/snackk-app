...
class AccountSuspendedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BreveScaffold(
      ...
      title: GlobalData.instance.suspendedTitle, drawer: BreveDrawer(), body: Center(child: Padding(padding: EdgeInsets.all(32), child:  Text(GlobalData.instance.suspendedString))));
  }
}